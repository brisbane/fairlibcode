hyperparameters_main={'all' :
        ...
        'weight_decay':[0.5, 0.7,1,2,10,100]
            ...
            'dadv':
            { 'adv_lambda' : [1,3,10],
              'adv_diverse_lambda': [0.01, 0.003, 0.001],
              'adv_num_discriminators': [ 1,3,5],
        'dropout': [0.0, 0.1],
        #'lr': [0.0001, 0.003,0.01, 0.001],
        'lr': [ 0.003,0.01, 0.1, 0.03],
        ...
        'weight_decay':[0.1,0.0],
             ...
             'hidden_size': [ 300 ],
             'softmax':[ False, True],
             'lr_scheduler': [ 'default', 'ReduceLROnPlateau', 'StepLR']
            },
            'BTEO':
